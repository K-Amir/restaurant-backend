<div x-data="{ modelOpen: false }" class="flex-1">
    ...
    <button {{ $attributes }} class="btns-outstanding-reservation button-accept-reservation" @click="modelOpen =!modelOpen">
        Aceptar
    </button>
        ...
        <div class="bg-dark-3 ring-highlight-regular border-highlight-regular border-2 w-full rounded-[8px] mx-auto relative mh-fit ransition duration-150 ease-in-out">
            ...
            >
                <div class="flex items-center justify-between space-x-4">
                    ...
                    <h6 class="text-lead-bold text-light-3 text-center mx-auto">La reserva ha sido aceptada</h6>
